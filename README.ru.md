...
### ✦ Перевод любого выделенного текста (`Ctrl+Alt+T`) — без скриншота
Выдели текст в **любом** приложении — браузер, редактор, PDF, чат — нажми сочетание, и рядом с
курсором всплывёт перевод. Работает через синтетическое копирование, переводит бесплатно или по
ключу DeepL, буфер обмена восстанавливается. Замена десктопному приложению DeepL.
